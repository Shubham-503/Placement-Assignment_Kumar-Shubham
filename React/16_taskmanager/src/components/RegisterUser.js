...
const RegisterUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const res = await axios.post('https://reqres.in/api/register',{username,email,password})
      //   console.log("##################")
      //   console.log(res)
      ...
      <div className="flex items-center justify-center h-screen w-full ">
        ...
        <div className="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] w-1/4">
          ...
          <div className="flex flex-col text-sm rounded-md">
            ...
            />
            <input
              className="mb-5 border rounded-[4px] p-3 hover:outline-none focus:outline-none hover:border-yellow-500"
              type="text"
